            ...
            <div class="col-md-12 col-12">
                ...
                align-items-center">
                                            <div>
                                                <div class="icon-shape icon-md border p-4
                    rounded-1">
                                                    <img src="{{ asset('admin_assets/images/brand/slack-logo.svg') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
                ...
                bg-danger">High</span>
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            ...
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-6.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                                <span
                    ...
                    rounded-1">
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-7.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-8.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-9.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                                <span
                ...
                align-items-center">
                                            <div>
                                                <div class="icon-shape icon-md border p-4
                    rounded-1">
                                                    <img src="{{ asset('admin_assets/images/brand/3dsmax-logo.svg') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
                ...
                bg-warning">Medium</span>
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-10.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-11.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img alt="avatar"
                                                    src="{{ asset('admin_assets/images/avatar/avatar-12.jpg') }}"
                                                    class="rounded-circle">
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                                <span
                ...
                align-items-center">
                    ...
                    bg-primary">
                                                    <img src="{{ asset('admin_assets/images/brand/layers-logo.svg') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
