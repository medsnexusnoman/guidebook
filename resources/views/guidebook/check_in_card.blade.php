                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    ...
                                    <div class=" col-12 col-md-3">
                                        <input type="time" class="form-control" placeholder="Card name" id="check_in"
                                            ...
                                            <div class="m-2">
                                                <div class="form-check ">
                                                    <input name="customChecktellMe" type="checkbox" id="customChecktellMe"
                                                        class="form-check-input">
                                                    <label for="customChecktellMe" class="form-check-label">Unfortunately we
                                                        cannot accommodate checking in before this time.</label>
                                                </div>
                                                <div class="form-check mt-1">
                                                    <input name="customOpenEmail" type="checkbox" id="customOpenEmail"
                                                        class="form-check-input">
                                                    <label for="customOpenEmail" class="form-check-label">Occasionally we
                                                        accommodate checking in at other times, if you contact us.</label>
                                                </div>
                                                <div class="form-check mt-1">
                                                    <input name="customShowDefault" type="checkbox" id="customShowDefault"
                                                        class="form-check-input">
                                                    <label for="customShowDefault" class="form-check-label">We are happy to
                                                ...
                                                <div class="form-check mt-1">
                                                    <input name="customShowDefault" type="checkbox" id="customShowDefault"
                                                        class="form-check-input">
                                                    <label for="customShowDefault" class="form-check-label">Enter your own
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-8 col-12">
                                            <div class="m-2">
                                                ...
                                                <div class="form-check mt-1">
                                                    <input name="customOpenEmail" type="checkbox" id="customOpenEmail"
                                                        class="form-check-input">
                                                    <label for="customOpenEmail" class="form-check-label">We'll be there
                                                ...
                                                <div class="form-check mt-1">
                                                    ...
                                                    <label for="customShowDefault" class="form-check-label">We will email
