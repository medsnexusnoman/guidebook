                                            ...
                                            <div class="col-8">
                                                <div class="d-flex">
                                                    ...
                                                    <select name="" class="form-control form-select"
                                                        ...
                                                        <option disabled selected class="text-dark">Custom recommendations-only URL key:</option>
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="d-flex">
                                                    ...
                                                    <select name="" class="form-control form-select"
                                                        style="width: 100%;" id="dailyDigest">
                                                        <option disabled selected class="text-dark">Recommendations-only URL</option>
                                                        <option value="One" class="text-dark">One</option>
                                                        <option value="Two" class="text-dark">Two</option>
                                                        <option value="Three" class="text-dark">Three</option>
                                                    </select>
