        ...
        <div class="card-body">
            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        <div class=" col-12"><input type="text" class="form-control" placeholder="Address"
                                id="address" name="address" required=""></div>
                    </div>
                ...
                <div class="col-6">
                    <div class="mb-3 row">
                        <div class=" col-12"><input type="text" class="form-control"
                                placeholder="Prefix/apartment no." id="apartment_no" name="apartment_no" required="">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class=" col-12"><input type="text" class="form-control" placeholder="Street Name"
                                id="street_name" name="street_name" required=""></div>
                    </div>


                    <div class="mb-3 row">
                        <div class=" col-12"><input type="text" class="form-control" placeholder="City/ suburb *"
                                id="city" name="city" required=""></div>
                    </div>


                    <div class="mb-3 row">
                        <div class=" col-12"><input type="text" class="form-control" placeholder="Country *"
                                id="country" name="country" required=""></div>
                    </div>

                    <div class="mb-3 row">
                        <div class=" col-12"><input type="text" class="form-control" placeholder="Postal Code"
                                id="postal_code" name="postal_code" required=""></div>
                    </div>
                </div>
            ...
            <div class=" mb-6 mt-3">
                ...
                <p>In the Arrival section of your guidebook, we construct a link to google maps for your guests. Here
            ...
            <div class="row">
                <div class="col-md-8 col-12">
                    <select name="" class="form-control form-select" id="country">
                        <option value="" class="text-muted">Address Linking Rule
                        </option>
                        <option value="India" class="text-dark">Automatic</option>
                        <option value="US" class="text-dark">use address</option>
                        <option value="UK" class="text-dark">use lat/lon</option>
                    </select>
                </div>
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="mb-3 row">
                        <div class=" col-12 col-md-8"><input type="text" class="form-control"
                                placeholder="Descriptive Name" id="descriptive_name" name="descriptive_name"
                                required=""></div>
                    </div>
                </div>
            </div>
